          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: FilledButton(
                ...
                child: const Text('J\'ai lu', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
              ),
            ),
          ),
        ],
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(body, style: const TextStyle(fontSize: 14, height: 1.5, color: AppColors.label)),
        ],
      ),
    );
  }
