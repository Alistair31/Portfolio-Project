...
<details>
  ...
  <ol>
    <li><a href="#team-formation">TEAM FORMATION</a></li>
...
The formation of this team was materialized through a meeting around the following project, its challenges and our capabilities at the time.  
...
A prototype has already been developed by the firm, it gave us a better idea of what they want and also the frontend style.  
  
We tried to find similar applications or websites to see what was already done and briefly study their impact on users.
...
We then discussed what technology would be the best to use and what type of database management system to put our application on, based on an expectation of the number of people that would have an account on it.

For the development tools, we use VSCode, git/github, Next.js and Flutter to build a mobile application.  
<div align="center">
...
For the database, we had to choose between PostgreSQL and MongoDB, taking into consideration that there will be a maximum load in terms of the number of accounts. Also, one of them uses SQL, which would be helpful to practice for the upcoming diploma.
...
After choosing all the necessary stacks, we then talked about the main objective of the project and how we might translate it into a functional software.
The idea is:

- a mobile application that provides, to all students, a way to post a report of harassment and other problematic behavior.
...
We did a feasibility study to evaluate the project and build an MVP concept. This has several criteria to define:

- Is the project feasible for a beginner team ( on a scale from 0 to 5 )
...
|Feature|Details|Challenges|Difficulty|Priority|
|:--|:--|:--|:--|:--:|
...
|Harassment Report (user)        |A page with multiple choice (type of harassment, gravity, effect on victim                                |Anonymization system (3 levels)                                          |2/5|🟥|
|Witness Report (user)           |A page similar to the harassment report,                                                                  |Same as Harassment Report                                                |2/5|🟨|
...
|Chatbot integration (optional)  |An AI chatbot (provided by the firm) to integrate for helping victims to communicate.                     |Potential danger concerning the response of the bot                      |5/5|🟩|  

<p align="right">(<a href="#readme-top">back to top</a>)</p>

<h2><u>DECISION AND REFINEMENT</u></h2>

Following a meeting with the team and the project lead, we received the statement of work.
...
The project has been launched because of a lack of similar entities specialized for this subject.
...
- A report page for students to post testimonies about the issues.
- An issue tracker: one for students to follow their own report, one for admins to follow all of them.  
...
- The security of personal data (high priority).
